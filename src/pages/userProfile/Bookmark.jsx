...
const Bookmark = ({ userDetails }) => {
  ...
  const data1 = posts || [];
  const myBookmark = data1?.filter((post) => logInProfileData?.bookmarked?.some((bookmark) => bookmark.post.toString() === post._id.toString()));
            ...
            <div className="card   p-4">
              <div className="card-body">
                <div className="d-flex mb-3">
                  ...
                  {userDetails._id === post?.comments?.find((user) => user.user) && (
                    <div className="ms-auto">
                      ...
                      ></i>
                      <Link to="/userProfile/editPosts" state={{ post, userDetails }}>
