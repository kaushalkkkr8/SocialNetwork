...
import { addBookMark, fetchUser, /*fetchLogInUser ,*/ removeBookMark } from "../../features/userSlice";
...
const Bookmark = () => {
  ...
  const data1 = posts || [];
  const myBookmark = data1?.filter((post) => userData?.bookmarked?.some((bookmark) => bookmark.post.toString() === post._id.toString()));
        ...
        <div className=" my-4">
          <div className="row">
            ...
            <div className="col-md-6">
              {myBookmark?.map((post, index) => {
                const userOfPostData = allUser.find((user) => post?.user === user?._id);
                    ...
                    <div className="card   p-4">
                      <div className="container">
                        <div className="d-flex mb-3">
                          ...
                          {userData._id === post?.comments?.find((user) => user.user) && (
